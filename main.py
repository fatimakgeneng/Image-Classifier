...
# Sidebar: Developer Info
    st.sidebar.markdown("<h1 style='text-align: center; margin-top: -30px; margin-bottom: 10px;'>👩‍💻Developed By</h1>", unsafe_allow_html=True)
    ...
    st.sidebar.markdown(
        ...
        <div style='text-align: center; padding-top: 10px;'>
            <p style='font-size: 20px; font-weight: bold; margin: 5px 0;'>Fatima Khan</p>
